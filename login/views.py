...
def home(request):
    if 'user_id' in request.session: 
        ...
        return render (request,'authenticate/index.html',{'products':products,'cate':cate,'customer':customer,'log':log})    
    else:
        cate=Category.objects.all()  
        products=Product.objects.all()
        log=False
        return render(request,'authenticate/index.html',{'products':products,'cate':cate,"log":log})
...
#     return render(request,'authenticate/guest_index.html',{'products':products,'cate':cate})     
